# ex-sqlserver
An example of how to use tedious to execute SQL commands
...
## Understand
In the root directory of the project: ./ex-sqlserver, you find:
...
* tedious npm - https://www.npmjs.com/package/tedious
* tedious api - http://tediousjs.github.io/tedious/
